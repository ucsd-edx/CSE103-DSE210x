...
# ## Intro
# 
# Translator will translate .imd files into .xml files.
# XML files can then be paste into edX studio to create problems.


# ## Running Code
# 
# This code is meant to be run as a **.py** file.
# Run "python translate.py -h" for more information.
...
class Translator:
    ...
    """
    The translator class translates imd files into xml files.     
    """
