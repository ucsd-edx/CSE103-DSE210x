...
if __name__ == '__main__':
    if len(sys.argv) == 2:
        ...
        print "You can convert all .md files to .imd files in one directory. Please run 'python md_to_imd.py <dir_name>'"
        print "You can convert one .md file at a time. Please run 'python md_to_imd.py <filename.md> <new_filename.imd>'"
